...
export class CreateAttendance1758072817158 implements MigrationInterface {
    name = 'CreateAttendance1758072817158'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."attendances_status_enum" AS ENUM('registered', 'cancelled')`);
        await queryRunner.query(`CREATE TABLE "attendances" ("id" SERIAL NOT NULL, "registeredAt" TIMESTAMP NOT NULL DEFAULT now(), "status" "public"."attendances_status_enum" NOT NULL DEFAULT 'registered', "cancelledAt" TIMESTAMP, "userId" integer, "eventId" integer, CONSTRAINT "UQ_53702aede8810d27769afda7705" UNIQUE ("userId", "eventId"), CONSTRAINT "PK_483ed97cd4cd43ab4a117516b69" PRIMARY KEY ("id"))`);
